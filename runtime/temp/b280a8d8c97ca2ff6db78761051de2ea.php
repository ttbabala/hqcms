<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"E:\www\web\hqcms\template/admin\system\index.html";i:1506591453;s:50:"E:\www\web\hqcms\template/admin\layout\common.html";i:1507263915;s:50:"E:\www\web\hqcms\template/admin\public\header.html";i:1503941668;s:47:"E:\www\web\hqcms\template/admin\public\nav.html";i:1506242403;s:48:"E:\www\web\hqcms\template/admin\public\menu.html";i:1507530011;s:50:"E:\www\web\hqcms\template/admin\public\footer.html";i:1506242424;}*/ ?>
<!--载入头部-->
...
<head>
    ...
    <link href="http://localhost/hqcms/public/admin/css/public.css" rel="stylesheet" type="text/css">
    <link href="http://localhost/hqcms/public/admin/css/laydate.css" rel="stylesheet" type="text/css">
    <link href="http://localhost/hqcms/public/admin/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="http://localhost/hqcms/public/admin/plugins/uploadify/css/uploadify.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/plugins/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/js/jquery.min.js"></script>
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/plugins/layer/layer.min.js"></script>
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/js/global.js"></script>
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/js/laydate.js"></script>
    <script type="text/javascript" src="http://localhost/hqcms/public/admin/js/laydate.dev.js"></script>
<style>
...
<div id="dcWrap"> <div id="dcHead">
    <div id="head">
        <div class="logo"><a href="index.html"><img src="http://localhost/hqcms/public/admin/images/dclogo.gif" alt="logo"></a></div>
        <div class="nav">
            <ul>
...
<script type="text/javascript" src="http://localhost/hqcms/public/admin/plugins/jquery-1.8.3.min.js"></script>
<script src="http://localhost/hqcms/public/admin/plugins/layer/layer.min.js"></script>
...
<div id="dcLeft">
    <div id="menu">
        ...
        <ul>
            <li><a href="<?php echo url('Databackup/bak'); ?>"><i class="backup"></i><em>短信接口</em></a></li>
...
<div id="dcMain">
     ...
     <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        ...
        <!--引入js-->
        <script type="text/javascript" src="http://localhost/hqcms/public/admin/plugins/jquery-1.8.3.min.js"></script>
        <script type="text/javascript" src="http://localhost/hqcms/public/admin/plugins/uploadify/js/jquery.uploadify.min.js"></script> 
        <script src="http://localhost/hqcms/public/admin/plugins/layer/layer.min.js"></script>
        <script type="text/javascript">
        ...
        $(function(){
                    //swfobject.embedSWF('http://localhost/hqcms/public/admin/plugins/uploadify/swf/uploadify.swf', "sd_file", "120", "30", "#666");
                    $(".uploadify").each(function(i) { 
                        $(this).uploadify({                            //多按钮上传幻灯片
                            'swf'           :  'http://localhost/hqcms/public/admin/plugins/uploadify/swf/uploadify.swf',
